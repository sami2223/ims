...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <form id="regForm" action="/students/storeFee/{{ $student->id }}" method="post" class="form-horizontal">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <div class="row form-group">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" id="" name="student_id" value="{{ $student->id }}" class="form-control"
                                    disabled>
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="text-input" class=" form-control-label">Student Name</label>
                                <input type="text" id="" name="student_name"
                                    value="{{ $student->first_name . ' ' . $student->last_name }}" class="form-control"
                                    disabled>
                            </div>
                        </div>
                        
                        <div id="new_payment" class="row form-group">
                        ...
                        <div class="row form-group monthly">
                            <div class="col-12 col-md-6">
                                <label for="text-input" class=" form-control-label">Month<span
                                    class="text-danger">*</span></label>
                                <select name="selectMonth" class="form-control select2" data-error="#errorMonth"
                                    required>
                                    <option value="">Please select</option>
                            ...
                            <div class="col-12 col-md-6">
                                <label for="text-input" class=" form-control-label">Year<span
                                    class="text-danger">*</span></label>
                                <select name="selectYear" class="form-control select2" data-error="#errorYear"
                                    required>
                                    <option value="">Please select</option>
    ...
    <script>
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response['data'] != null) {
                            if(response['data'][0].course_id == {{ $student->session_id }}){
            ...
            //         </div>
            //         <div class="col-12 col-md-4">
            //             <label for="text-input" class=" form-control-label">Fee Amount<span
            //                     class="text-danger">*</span></label>
            //             <input type="number" id="fee" name="fee" class="form-control" data-error="#errorfee"
            //                 required>
            //             <span id="errorfee"></span>
            //             @error('fee')
            //                 <span class="text-danger">{{ $message }}</span>
            //             @enderror
            //         </div>
            ...
            //             <input type="button" id="" value="Add New" class="btn btn-success form-control mt-2 add_new">
            //         </div>
            //     </div>`;
            //     alert(new_div);
            //     $('#new_payment').append(new_div);
