...
@section('content')
    ...
    <div class="container-fluid d-flex justify-content-center">
        ...
        <div class="col-lg-6">
            <form id="regForm" action="/categories" method="post" class="form-horizontal">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-8">
                                <input type="text" id="title" name="title" placeholder="" class="form-control" data-error="#error">
                                <span id="error"></span>
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-8">
                                <input type="text" id="cat_description" name="description" placeholder="" class="form-control">
                            </div>
                        </div>
